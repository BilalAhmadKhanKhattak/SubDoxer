...
SubDoxer is a Python tool designed for discovering subdomains associated with a target domain. This tool is 
practical for cybersecurity enthusiasts and penetration testers who want to map out potential subdomains quickly and 
efficiently.

SubDoxer Version 1.1 uses a predefined list of over 500 common and potential subdomains to check against a target 
